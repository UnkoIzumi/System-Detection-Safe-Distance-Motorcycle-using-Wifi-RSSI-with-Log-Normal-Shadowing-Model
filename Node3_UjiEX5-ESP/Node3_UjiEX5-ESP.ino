...
float rssi_1, rssi_2;
int wifiChannel_1, wifiChannel_2;
float* getData;
//const char* ssid = "KelinciPercobaanLite";
//const char* password = "qweyrty123";
...
float pathLossExponent = 2.5; // Path loss exponent (shadowing urban celluar radio 3-5)
  ...
  if (n == 0) {
    ...
    for (int i = 0; i < n; ++i) {
      ...
      if (ssid == "Node-1 ESP") {
        ...
        rssi_2 = WiFi.RSSI(i);
        wifiChannel_2 = WiFi.channel(i) * 5 + 2407;
        distance_node2 = LNSM(rssi_2);
        Serial.print("RSSI Node 2: ");
        Serial.print(rssi_2, 0);
        Serial.print(", Freq: ");
        Serial.print(wifiChannel_2);
        Serial.print(", distance: ");
        Serial.println(distance_node2);
        //        dataOutn2 = 2;
      }
    }
  }
