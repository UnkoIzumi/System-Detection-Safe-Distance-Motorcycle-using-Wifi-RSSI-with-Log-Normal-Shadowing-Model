...
void ledNotif(void) {
  if ((51 <= veloKm) && (veloKm >=  60)) {
    if ((distance_node2 < 41) || (distance_node3 < 41)) {
    ...
    if ((distance_node2 < 25) || (distance_node3 < 25)) {
      digitalWrite(ledRed, HIGH);
      digitalWrite(ledYellow, LOW);
      digitalWrite(ledGreen, LOW);
    ...
    if ((distance_node2 < 20) || (distance_node3 < 20)) {
      digitalWrite(ledRed, HIGH);
      digitalWrite(ledYellow, LOW);
      digitalWrite(ledGreen, LOW);
    ...
    if ((distance_node2 < 15) || (distance_node3 < 15)) {
      digitalWrite(ledRed, HIGH);
      digitalWrite(ledYellow, LOW);
      digitalWrite(ledGreen, LOW);
